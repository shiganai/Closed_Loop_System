...
F_X = -functionalDerivative(L, x_Pre) - f_X * diff(p2(1), x_Pre) - f_Y * diff(p2(2), x_Pre);
F_Y = -functionalDerivative(L, y_Pre) - f_X * diff(p2(1), y_Pre) - f_Y * diff(p2(2), y_Pre);
...
equations = [
    restraint;
    -functionalDerivative(L, th1_Pre(t)) == tau1 + f_X * diff(p2(1), th1_Pre) + f_Y * diff(p2(2), th1_Pre);
    -functionalDerivative(L, th2_Pre(t)) == tau2 + f_X * diff(p2(1), th2_Pre) + f_Y * diff(p2(2), th2_Pre);
    ];
